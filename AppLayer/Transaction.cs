            ...
            while (true)
            {
                ...
                switch (checkbal)
                {
                    ...
                    case 2:
                        ...
                        using (StreamWriter sw = new StreamWriter(File.Create("C:\\Users\\ADMIN\\source\\repos\\ATM\\ClassLibrary1\\WithdrawalReceipt.txt")))
                        {
                    ...
                    case 3:
                        ...
                        Console.WriteLine("\n Current Balance is: {0}\n", amount);
                        using (StreamWriter sw = new StreamWriter(File.Create("C:\\Users\\ADMIN\\source\\repos\\ATM\\ClassLibrary1\\DepositReceipt.txt")))
                        {
